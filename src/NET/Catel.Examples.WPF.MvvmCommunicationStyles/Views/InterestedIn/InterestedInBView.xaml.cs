// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InterestedInBView.xaml.cs" company="Catel development team">
...
namespace Catel.Examples.MvvmCommunicationStyles.Views
{
    ...
    /// <summary>
    /// Interaction logic for InterestedInBView.xaml.
    /// </summary>
    public partial class InterestedInBView : UserControl
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterestedInBView"/> class.
        /// </summary>
        public InterestedInBView()
        {
            InitializeComponent();
        }
