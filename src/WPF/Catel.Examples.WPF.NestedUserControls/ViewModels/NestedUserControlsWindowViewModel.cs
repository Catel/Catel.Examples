namespace Catel.Examples.AdvancedDemo.ViewModels
{
    ...
    /// </summary>
    public class NestedUserControlsWindowViewModel : ViewModelBase
    {
        #region Constructor & destructor
        /// <summary>
        /// Initializes a new instance of the <see cref="NestedUserControlsWindowViewModel"/> class.
        /// </summary>
        public NestedUserControlsWindowViewModel()
        {
