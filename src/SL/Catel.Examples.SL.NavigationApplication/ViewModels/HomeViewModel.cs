namespace Catel.Examples.SL.NavigationApplication.ViewModels
{
    ...
    public class HomeViewModel : ViewModelBase
    {
        ...
        public HomeViewModel(INavigationService navigationService)
        {
            ...
            NavigateToAboutViaViewModel = new Command<object>(OnNavigateToAboutViaViewModelExecute);
        }
        #endregion
        ...
        #region Commands
        /// <summary>
        /// Gets the NavigateToAboutViaViewModel command.
        /// </summary>
        public Command<object> NavigateToAboutViaViewModel { get; private set; }
        ...
        private void OnNavigateToAboutViaViewModelExecute(object parameter)
        {
            ...
            _navigationService.Navigate<AboutViewModel>(parameters);
        }
        #endregion
